...
namespace AuctionService {
    ...
    static AuctionsReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "CgoCaWQYASABKAkihwEKEEdycGNBdWN0aW9uTW9kZWwSCgoCaWQYASABKAkS",
            "EQoJc2VsbGVyX2lkGAIgASgJEhUKDXJlc2VydmVfcHJpY2UYAyABKAkSGAoQ",
            "Y3VycmVudF9oaWdoX2JpZBgEIAEoCRITCgthdWN0aW9uX2VuZBgFIAEoCRIO",
            "CgZzdGF0dXMYBiABKAkiOQoTR3JwY0F1Y3Rpb25SZXNwb25zZRIiCgdhdWN0",
            "aW9uGAEgASgLMhEuR3JwY0F1Y3Rpb25Nb2RlbDJFCgtHcnBjQXVjdGlvbhI2",
            "CgpHZXRBdWN0aW9uEhIuR2V0QXVjdGlvblJlcXVlc3QaFC5HcnBjQXVjdGlv",
            "blJlc3BvbnNlQhGqAg5BdWN0aW9uU2VydmljZWIGcHJvdG8z"));
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          ...
          new pbr::GeneratedClrTypeInfo(null, null, new pbr::GeneratedClrTypeInfo[] {
            ...
            new pbr::GeneratedClrTypeInfo(typeof(global::AuctionService.GrpcAuctionModel), global::AuctionService.GrpcAuctionModel.Parser, new[]{ "Id", "SellerId", "ReservePrice", "CurrentHighBid", "AuctionEnd", "Status" }, null, null, null, null),
  ...
  #endif
  {
    ...
    public GrpcAuctionModel(GrpcAuctionModel other) : this() {
      ...
      currentHighBid_ = other.currentHighBid_;
    ...
    private string reservePrice_ = "";
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public string ReservePrice {
      get { return reservePrice_; }
      set {
        reservePrice_ = pb::ProtoPreconditions.CheckNotNull(value, "value");
      }
    }

    /// <summary>Field number for the "current_high_bid" field.</summary>
    public const int CurrentHighBidFieldNumber = 4;
    private string currentHighBid_ = "";
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public string CurrentHighBid {
      get { return currentHighBid_; }
      set {
        currentHighBid_ = pb::ProtoPreconditions.CheckNotNull(value, "value");
      }
    }

    /// <summary>Field number for the "auction_end" field.</summary>
    public const int AuctionEndFieldNumber = 5;
    ...
    public bool Equals(GrpcAuctionModel other) {
      ...
      if (CurrentHighBid != other.CurrentHighBid) return false;
    ...
    public override int GetHashCode() {
      ...
      if (ReservePrice.Length != 0) hash ^= ReservePrice.GetHashCode();
      if (CurrentHighBid.Length != 0) hash ^= CurrentHighBid.GetHashCode();
    ...
    public void WriteTo(pb::CodedOutputStream output) {
      ...
      if (ReservePrice.Length != 0) {
        output.WriteRawTag(26);
        output.WriteString(ReservePrice);
      }
      if (CurrentHighBid.Length != 0) {
        output.WriteRawTag(34);
        output.WriteString(CurrentHighBid);
      }
    ...
    public int CalculateSize() {
      ...
      if (ReservePrice.Length != 0) {
        size += 1 + pb::CodedOutputStream.ComputeStringSize(ReservePrice);
      }
      if (CurrentHighBid.Length != 0) {
        size += 1 + pb::CodedOutputStream.ComputeStringSize(CurrentHighBid);
      }
      if (AuctionEnd.Length != 0) {
    ...
    public void MergeFrom(GrpcAuctionModel other) {
      ...
      if (other.ReservePrice.Length != 0) {
        ReservePrice = other.ReservePrice;
      }
      if (other.CurrentHighBid.Length != 0) {
        CurrentHighBid = other.CurrentHighBid;
      }
    ...
    public void MergeFrom(pb::CodedInputStream input) {
      ...
      switch(tag) {
          ...
          case 26: {
            ReservePrice = input.ReadString();
            break;
          }
          case 34: {
            CurrentHighBid = input.ReadString();
            break;
          }
          case 42: {
