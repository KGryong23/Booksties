...
import { GetOrderItemsById  } from "@/utils/action/action"
...
const ModalItems=(props :Iprop)=>{
    const { isModalOpenItems ,handleCancel,orderId } = props
    ...
    return(
      <Modal footer={null} width={'60rem'} title={`Chi tiết đơn hàng`} open={isModalOpenItems} onCancel={handleCancel}>
