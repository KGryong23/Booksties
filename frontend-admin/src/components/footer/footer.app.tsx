...
const FooterApp=()=>{
    return(
        <Footer style={{background:'#181818',marginTop:"4rem"}}>
            <div style={{borderBottom:'1px solid #A9A9A9',height:100,display:'flex',justifyContent:"space-between",marginTop:"1rem"}}>
               <div style={{color:"white",fontSize:25,width:'50%',fontFamily:'cursive'}}></div>
